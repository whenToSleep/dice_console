# Задча №1: Использовать словари для баланса игроков и банка
# Задача №2: использовать try-except для отслеживания ошибок

# Пример использования словаря и передачи
# #def main():
#     balances = {
#         "player1": 1000,
#         "player2": 1000
#     }
#     dice(balances)  # Передаем balances в функцию dice()
#
# def dice(balances):
#   balances["player1"] -= 100

# Работа с трай-экспект
# try:
#     command = input("Введите команду: ").split()
#     bet = int(command[1])  # Ошибка, если command[1] не число
# except ValueError:
#     print("Ошибка: ставка должна быть числом!")

# Важно понимать:
#
# IndexError возникает раньше, если элемента command[1] вообще нет.
# ValueError возникает только если command[1] есть, но оно не число
